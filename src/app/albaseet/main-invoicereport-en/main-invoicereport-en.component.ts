...
@Component({
  selector: 'app-main-invoicereport-en',
  templateUrl: './main-invoicereport-en.component.html',
  styleUrls: ['./main-invoicereport-en.component.css']
})
export class MainInvoicereportENComponent {
  Allinvioce: boolean;
