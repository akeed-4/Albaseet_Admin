...
@Component({
  selector: 'app-report-recipt-main',
  templateUrl: './report-recipt-main.component.html',
  styleUrls: ['./report-recipt-main.component.css']
})
export class ReportReciptMainComponent {
