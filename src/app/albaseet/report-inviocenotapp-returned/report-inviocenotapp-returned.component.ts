...
@Component({
  selector: 'app-report-inviocenotapp-returned',
  templateUrl: './report-inviocenotapp-returned.component.html',
  styleUrls: ['./report-inviocenotapp-returned.component.css']
})
export class ReportInviocenotappReturnedComponent {
 ...
 getAllInvioce(){
  this.servicess.GetAllInices().subscribe((list: any) => {
    ...
    this.invoice = this.storedata.filter((x: any) => x.invoice_type==="003"&&x.invoice_acceptance === 0)
